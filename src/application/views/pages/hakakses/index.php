                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= $update_url . $key ?>"
                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Role">
                                    ...
                                    <a href="<?= $delete_url . $key ?>"
                                        class="ts_remove_row btn btn-icon btn-bg-light btn-active-color-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Role">
