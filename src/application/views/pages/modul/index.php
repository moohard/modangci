                    ...
                    if ($datas != FALSE)
                    {
                        ...
                        foreach ($datas as $row)
                        {
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?= $row->susrmodulIsLogin == 1 ? 'YA' : 'TIDAK' ?></td>
                                <td class="text-end"><?= $row->susrmodulUrut ?></td>
                                <td class="text-center">
                                    <a href="<?= $update_url . $key ?>"
                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Menu">
                                    ...
                                    <a href="<?= $delete_url . $key ?>"
                                        class="ts_remove_row btn btn-icon btn-bg-light btn-active-color-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Menu">
