                ...
                <table class="table table-hover table-bordered" id="table_general">
                    <thead class="fw-bold fs-6 text-gray-800">
                        <tr>
                            ...
                            <th class="text-center">Group Nama</th>
                            <th class="text-center">Group Display</th>
                            <th class="text-center">Group Icon</th>
                        ...
                        if ($datas != FALSE)
                        {
                            ...
                            foreach ($datas as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $row->susrmdgroupIcon ?></td>
                                    <td class="text-center">
                                        <a href="<?= $update_url . $key ?>"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Grup Modul">
                                        ...
                                        <a href="<?= $delete_url . $key ?>"
                                            class="ts_remove_row btn btn-icon btn-bg-light btn-active-color-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus Grup Modul">
