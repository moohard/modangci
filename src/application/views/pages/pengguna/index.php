                ...
                <table class="table table-hover table-bordered" id="table_general">
                    <thead class="fw-bold fs-6 text-gray-800">
                        <tr>
                            ...
                            <th class="text-center">Profil Name</th>
                        ...
                        if ($datas != FALSE)
                        {
                            ...
                            foreach ($datas as $row)
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><?= $row->susrLastLogin ?></td>
                                    <td class="text-center">
                                        ...
                                        <a href="<?= $resetpassword_url . $key ?>"
                                            class="ts_reset_row btn btn-icon btn-bg-light btn-active-color-warning btn-sm"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Reset Password Pengguna" data-id="<?=$key?>">
